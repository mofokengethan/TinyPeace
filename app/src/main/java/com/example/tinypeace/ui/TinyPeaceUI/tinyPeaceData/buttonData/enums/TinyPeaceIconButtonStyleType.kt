 ...
 * ## Enum Values
 *
 * - ***Regular***: Corresponds to image (1)
 * - ***Filled***: Corresponds to image (2)
 * - ***FilledTonal***: Corresponds to image (3)
 * - ***Outlined***: Corresponds to image (4)
 */
enum class TinyPeaceIconButtonStyleType {
    Regular, // (1)
    Filled, // (2)
    FilledTonal, // (3)
    Outlined, // (4)
